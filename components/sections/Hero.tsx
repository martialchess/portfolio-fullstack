...
export default function Hero() {
  return (
    <section id="hero" className="py-20 px-4 bg-background relative">
      {/* Main Glass Card */}
      <div className="max-w-3xl mx-auto bg-blue-100 bg-opacity-100 shadow-xl rounded-3xl flex flex-col-reverse md:flex-row items-center justify-between px-10 py-14 backdrop-blur-md">
        {/* Left: Text */}
        ...
        <div className="md:w-1/2 flex justify-center mb-15 md:mb-0">
          <Image
            ...
            width={200}
            height={200}
            className="w-[230px] h-[230px] rounded-full shadow-lg object-cover"
          />
        </div>
      </div>

      {/* Floating Stat Card */}
      <div className="max-w-3xl mx-auto -mt-10 z-10 relative bg-white shadow-lg rounded-4xl px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-6">
