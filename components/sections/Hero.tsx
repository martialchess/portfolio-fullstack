...
export default function Hero() {
  return (
    <section id="hero" className="py-20 px-4 bg-background relative">
      ...
      {/* Floating Stat Card */}
      <div className="max-w-4xl mx-auto -mt-15 z-10 relative bg-white shadow-lg rounded-4xl px-4 py-6 flex flex-col md:flex-row justify-between items-center gap-6">
        {/* Experience */}
